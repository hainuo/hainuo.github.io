...
blog.constant('blogConfig',{
    "site_name":"海诺博客公告板",
    "pagesize":10,//每页显示文章数
    "duoshuo_domain":"hainuo",//多说评论，你在多说上申请的二级域名
    "categories":["PHP","ThinkPHP","服务器","数据库","前端","HTML5","CSS","javascript","jQuery","bootstrap","angularjs","python","工具","编辑器"],
    "AVOS_ID":"wvvg3lcfh3w9bx2gbz808pjdbkqzfmh8ibk6jafvyugcmrfn",
    "AVOS_KEY":"5rjf7jp671ze6ujjo2kvgca9gytpieunurgdjtd979yfqo8f",
    "header_pics":[
